...
class AudioBarPanelWidget extends StatefulWidget {
  ...
  @override
  _AudioBarPanelWidgetState createState() => _AudioBarPanelWidgetState();
}

class _AudioBarPanelWidgetState extends State<AudioBarPanelWidget> {
              ...
              children: <Widget>[
                ...
                !isPlayShowCont ? SizedBox() : Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      IconButton(
                        icon: Image.asset(_playing ? 'images/pause.png' : 'images/play.png',
                      width: 50, height: 50),
